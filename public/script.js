// РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’
// AURA MESSENGER РІР‚вЂќ script.js
...
function buildCustomVideoPlayer(src) {
  ...
  badge.innerHTML = `<i class="ti ti-video"></i><span class="cvp-badge-dur">РІР‚вЂќ</span>`;
  ...
  speedBtn.addEventListener('click', e => {
    ...
    speedBtn.textContent = speeds[speedIdx] + 'Р“вЂ”';
  });
...
// РІвЂќР‚РІвЂќР‚ Socket (must be first) РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
// РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’
// STATE  РІвЂ С’ single source of truth
// РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’
...
function hideAllToasts() {
  document.querySelectorAll('#toastContainer .toast').forEach(closeToast);
}
function toast(msg, type = 'info', dur = 3500) {
  const key = `${type}|${String(msg || '').trim()}`;
  const lastAt = Number(_recentToasts.get(key) || 0);
  if (Date.now() - lastAt < 1200) return;
  ...
  el.innerHTML = `<i class="ti ${icons[type] || icons.info}"></i><span class="toast-text">${msg}</span><button class="toast-close" type="button" aria-label="РЎРєСЂС‹С‚СЊ"><i class="ti ti-x"></i></button>`;
  $('toastContainer').appendChild(el);
  const close = () => closeToast(el);
...
// РІвЂќР‚РІвЂќР‚ FORGOT PASSWORD РІР‚вЂќ Р С”РЎР‚Р В°РЎРѓР С‘Р Р†РЎвЂ№Р в„– Р СР С•Р Т‘Р В°Р В» РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
let _forgotUsername = '';
let _forgotCode     = '';
...
function notificationsEnabled() {
  return localStorage.getItem('aura_browser_notifications') !== '0';
}

function loadNotificationPrefs() {
  const toggle = $('notifBrowserToggle');
...
function saveNotificationPrefs() {
  ...
  localStorage.setItem('aura_browser_notifications', enabled ? '1' : '0');
...
if (savedUser && savedPass) {
  ...
  .then(d => {
    ...
    if (d.success) { startSession(d.user); }
      ...
      // Password changed or account deleted РІР‚вЂќ show login
...
function renderRequests() {
  ...
  if (sentFriendRequests.length) {
    addSection('РСЃС…РѕРґСЏС‰РёРµ');
    sentFriendRequests.forEach(req => {
      const li = document.createElement('li');
      li.className = 'req-item req-item-out';
      const ava = document.createElement('div');
      ava.className = 'ci-ava';
      setAvatar(ava, req, userAvatars[req]);
      li.appendChild(ava);
      li.innerHTML += `
        <div class="ci-body"><span class="ci-name">${req}</span><span class="ci-sub">Р’С‹ РѕС‚РїСЂР°РІРёР»Рё Р·Р°СЏРІРєСѓ</span></div>
        <div class="req-btns">
          <button class="req-cancel" onclick="cancelSentReq('${req}')"><i class="ti ti-x"></i><span>РЈР±СЂР°С‚СЊ</span></button>
        </div>`;
      ul.appendChild(li);
    });
  }
    ...
    if (room.startsWith('private:')) {
      ...
      if (partner) {
        ...
        if (document.hidden) {
          ...
          const preview = msg.text ? plainMsgText(msg.text).slice(0, 60) : 'рџ“Ћ Р’Р»РѕР¶РµРЅРёРµ';
...
function fileUrl(url) {
  ...
  // B2: /file/BUCKET/path РІвЂ вЂ™ /api/dl?f=path
...
// РІвЂќР‚РІвЂќР‚ Read receipts РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
function addMessage(msg) {
  ...
  // Avatar РІР‚вЂќ mark with data-user so avatar-updated can refresh it
  const ava = document.createElement('div');
  ...
  // РІвЂќР‚РІвЂќР‚ Р вЂ”Р В°Р С—Р С‘РЎРѓРЎРЉ Р С• Р В·Р Р†Р С•Р Р…Р С”Р Вµ (Р С‘Р В· Р С‘РЎРѓРЎвЂљР С•РЎР‚Р С‘Р С‘) РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
  ...
  if (msg.type === 'image') {
    ...
    inner += `<div class="voice-player" id="${pid}">
      ...
      <div class="vp-body">
        ...
        <div class="vp-meta"><span class="vp-pos">0:00</span><span class="vp-dur">РІР‚вЂќ</span></div>
      </div>
    </div>`;
  ...
  bub.querySelectorAll('audio').forEach(a => {
    ...
    vp.innerHTML = `<button class="vp-play" onclick="vpToggle('${pid}','${url}')"><i class="ti ti-player-play"></i></button><div class="vp-body"><div class="vp-waveform" onclick="vpSeek(event,'${pid}','${url}')">${Array.from({length:30},(_,i)=>'<div class="vp-bar" style="height:'+(8+Math.round(Math.sin(i*.7+1)*8+Math.random()*8))+'px"></div>').join('')}</div><div class="vp-meta"><span class="vp-pos">0:00</span><span class="vp-dur">РІР‚вЂќ</span></div></div>`;
    a.replaceWith(vp);
  });

  // РІвЂќР‚РІвЂќР‚ Р СџРЎР‚Р В°Р Р†Р В°РЎРЏ Р С”Р Р…Р С•Р С—Р С”Р В° РІР‚вЂќ Р С”Р С•Р Р…РЎвЂљР ВµР С”РЎРѓРЎвЂљР Р…Р С•Р Вµ Р СР ВµР Р…РЎР‹ РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
  bub.addEventListener('contextmenu', e => {
      e.preventDefault();
      // РџСЂР°РІР°СЏ РєРЅРѕРїРєР° РЅРµ РґРѕР»Р¶РЅР° РґРѕР±Р°РІР»СЏС‚СЊ РІ РІС‹РґРµР»РµРЅРёРµ
      showCtxMsg(e, msg);
  ...
  // РІвЂќР‚РІвЂќР‚ Р С™Р В»Р С‘Р С” Р Р† РЎР‚Р ВµР В¶Р С‘Р СР Вµ Р Р†РЎвЂ№Р Т‘Р ВµР В»Р ВµР Р…Р С‘РЎРЏ РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
  ...
  if (!_historyLoading && msg.user !== currentUser && document.visibilityState !== 'visible') {
    ...
    const txt  = msg.type === 'text' ? plainMsgText(msg.text) : (msg.type === 'audio' ? 'Р“РѕР»РѕСЃРѕРІРѕРµ СЃРѕРѕР±С‰РµРЅРёРµ' : 'РњРµРґРёР°С„Р°Р№Р»');
...
function refreshSendBtn() {
  ...
  sendBtn.disabled = false; // always enabled РІР‚вЂќ mic when empty
  if (canSend) {
...
async function deleteSelectedMsgsAll() {
  ...
  cancelMsgSelect();
  // Delete for all РІР‚вЂќ only own messages
  for (const id of ids) {
    const row = document.querySelector(`[data-id="${id}"]`);
...
// РІвЂќР‚РІвЂќР‚ Р вЂ™РЎРѓРЎвЂљР В°Р Р†Р С”Р В° Р С‘Р В· Р В±РЎС“РЎвЂћР ВµРЎР‚Р В° Р С•Р В±Р СР ВµР Р…Р В° (Ctrl+V / Command+V) РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
// РІвЂќР‚РІвЂќР‚ Desktop: hold to record, right-click for circle РІвЂќР‚РІвЂќР‚
if (!isMobile) {
  ...
  sendBtn.addEventListener('mousedown', e => {
    ...
    if (isRecording) return; // РєР»РёРє РІРѕ РІСЂРµРјСЏ Р·Р°РїРёСЃРё РѕР±СЂР°Р±РѕС‚Р°РµРј РІ mouseup
    didHold = false;
  ...
  sendBtn.addEventListener('mouseup', e => {
    ...
    if (msgInput.value.trim() || selectedFiles.length) return;
    if (isRecording) {
      // РџРѕРІС‚РѕСЂРЅС‹Р№ РєР»РёРє вЂ” РѕСЃС‚Р°РЅРѕРІРёС‚СЊ Рё РѕС‚РїСЂР°РІРёС‚СЊ
      stopVoice();
      return;
    }
    // РћРґРёРЅРѕС‡РЅС‹Р№ РєР»РёРє РёР»Рё hold вЂ” РЅР°С‡Р°С‚СЊ Р·Р°РїРёСЃСЊ
    startVoice();
    didHold = false;
  });
...
// РІвЂќР‚РІвЂќР‚ Mobile: hold = voice, swipe up = circle РІвЂќР‚РІвЂќР‚
if (isMobile) {
  let ty0 = 0, holdT = null, mode = null;
  sendBtn.addEventListener('touchstart', e => {
    if (msgInput.value.trim() || selectedFiles.length) return;
    // Р•СЃР»Рё СѓР¶Рµ РёРґС‘С‚ Р·Р°РїРёСЃСЊ вЂ” СЃР»РµРґСѓСЋС‰РёР№ С‚Р°Рї РѕСЃС‚Р°РЅРѕРІРёС‚ РІ touchend
  ...
  sendBtn.addEventListener('touchend', () => {
    clearTimeout(holdT);
    if (isRecording) {
      // РџРѕРІС‚РѕСЂРЅС‹Р№ С‚Р°Рї вЂ” РѕСЃС‚Р°РЅР°РІР»РёРІР°РµРј Р·Р°РїРёСЃСЊ Рё РѕС‚РїСЂР°РІР»СЏРµРј
      stopVoice();
      return;
    }
    if (!mode) {
      // Р‘С‹СЃС‚СЂС‹Р№ С‚Р°Рї Р±РµР· hold вЂ” РЅР°С‡РёРЅР°РµРј Р·Р°РїРёСЃСЊ (toggle)
      startVoice();
    }
  });
...
// РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’
const EMOJIS = ['СЂСџВР‚','СЂСџВвЂљ','СЂСџВРЊ','СЂСџТђВ°','СЂСџВР‹','СЂСџВ¤вЂќ','СЂСџВвЂ¦','СЂСџТђР†','СЂСџВВ­','СЂСџВВ¤','СЂСџВ¤Р‡','СЂСџТђС–','СЂСџВТ‘','СЂСџв„ўвЂћ','СЂСџВРЏ','СЂСџВ«РЋ',
  'СЂСџвЂРЊ','СЂСџвЂР‹','РІСњВ¤РїС‘РЏ','СЂСџвЂќТђ','СЂСџвЂ™Р‡','РІСљвЂ¦','СЂСџР‹вЂ°','СЂСџР‹Р‰','СЂСџвЂ™Р„','СЂСџв„ўРЏ','СЂСџвЂР‚','СЂСџвЂ™Р‚','СЂСџВ¤Сњ','РІСљРЉРїС‘РЏ','СЂСџВ«В¶','СЂСџвЂ™В«',
  'СЂСџВС‘','СЂСџС’В¶','СЂСџРЉСџ','РІС™РЋ','СЂСџРЉв‚¬','СЂСџР‹Вµ','СЂСџР‹В®','СЂСџРЏвЂ ','СЂСџС™Р‚','СЂСџвЂ™В»','СЂСџвЂњВ±','СЂСџР‹Р‡','СЂСџвЂ™РЋ','СЂСџРЉв„ў','РІВР‚РїС‘РЏ','СЂСџРЉР‰'];
...
async function removeFriend(friend) {
  ...
  if (!ok) return;
  // No API endpoint for this in original РІР‚вЂќ just remove locally
    ...
    try {
      ...
      resultsEl.innerHTML = searchResults.map(u => {
        ...
        const friendBadge = u.isFriend
          ...
          : u.hasOutgoingRequest
            ? `<button class="btn-secondary" style="padding:5px 10px;font-size:11px;flex-shrink:0" onclick="event.stopPropagation(); cancelSentReq('${u.username}')"><i class="ti ti-clock-x"></i> РЈР±СЂР°С‚СЊ</button>`
            : u.hasIncomingRequest
              ? `<span style="font-size:10px;color:var(--accent);background:var(--accent-dim);border-radius:6px;padding:2px 7px;border:1px solid rgba(99,102,241,.22)"><i class="ti ti-arrow-down"></i> Р’С…РѕРґСЏС‰Р°СЏ</span>`
              : `<button class="btn-secondary" style="padding:5px 10px;font-size:11px;flex-shrink:0" onclick="event.stopPropagation(); sendFriendReqTo('${u.username}')"><i class="ti ti-user-plus"></i> Р”РѕР±Р°РІРёС‚СЊ</button>`;
        return `
          <div class="af-result-item" style="cursor:default">
  ...
  try {
    ...
    if (d.success) {
      if (d.autoAccepted) {
        ...
        sentFriendRequests = sentFriendRequests.filter(x => x !== username);
        renderFriends();
        toast(`${username} С‚РµРїРµСЂСЊ Сѓ РІР°СЃ РІ РґСЂСѓР·СЊСЏС…`, 'success');
      } else {
        sentFriendRequests = d.sentFriendRequests || [...new Set([...sentFriendRequests, username])];
        toast(`Р—Р°СЏРІРєР° РѕС‚РїСЂР°РІР»РµРЅР° ${username}!`, 'success');
      }
      renderRequests();
    }
...
async function cancelSentReq(req) {
  try {
    const r = await fetch('/api/cancel-friend-request', {
      method: 'POST', headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ from: currentUser, to: req })
    });
    const d = await r.json();
    if (d.success) {
      sentFriendRequests = d.sentFriendRequests || sentFriendRequests.filter(x => x !== req);
      renderRequests();
      toast(`Р—Р°СЏРІРєР° РґР»СЏ ${req} СѓР±СЂР°РЅР°`, 'info', 2200);
    } else {
      toast(d.error || 'РћС€РёР±РєР°', 'error');
    }
  } catch {
    toast('РћС€РёР±РєР°', 'error');
  }
}
...
socket.on('friend-requests-updated', ({ sentFriendRequests: nextSent }) => {
  if (!currentUser) return;
  sentFriendRequests = nextSent || [];
  renderRequests();
});

// New group created РІР‚вЂќ update groups list
...
function openSettings() {
  ...
  // Accent РІР‚вЂќ restore active state and checkmark
...
// РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’
...
function _aiUpdateAttachBar() {
  ...
  bar.innerHTML = `
    ${preview}
    <span style="flex:1;color:var(--text2)">СЂСџвЂњР‹ ${esc(_aiAttachment.name)}</span>
...
function _aiAddFileCard(file) {
  ...
  card.innerHTML = `
    ...
    <div style="flex:1;min-width:0">
      ...
      <div style="font-size:11px;color:var(--text2)">${ext} вЂў ${(file.content?.length||0).toLocaleString()} bytes вЂў keeps 5 turns</div>
...
const _aiToolLabels = {
  ...
  uuid_generate: 'СЂСџвЂ вЂќ UUID', slugify_text: 'СЂСџвЂќвЂ” Slug',
  csv_to_json: 'СЂСџвЂњвЂћ CSVРІвЂ вЂ™JSON', json_to_csv: 'СЂСџвЂњвЂћ JSONРІвЂ вЂ™CSV'
};

// Р”РѕР±Р°РІР»СЏРµС‚ РєРѕР»Р»Р°РїСЃРёСЂСѓРµРјС‹Р№ Р»РѕРі РёРЅСЃС‚СЂСѓРјРµРЅС‚РѕРІ (РєР°Рє РЅР° СЃРєСЂРёРЅРµ)
// РІвЂќР‚РІвЂќР‚ AI Р В·Р В°Р Т‘Р В°РЎвЂРЎвЂљ Р Р†Р С•Р С—РЎР‚Р С•РЎРѓ Р С—Р С•Р В»РЎРЉР В·Р С•Р Р†Р В°РЎвЂљР ВµР В»РЎР‹ РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
function _aiRestoreMainInputHandlers() {
  ...
  if (mainInput) {
    mainInput.placeholder = 'РЎРїСЂРѕСЃРёС‚Рµ С‡С‚Рѕ-РЅРёР±СѓРґСЊвЂ¦';
  ...
  if (!multi && (q.allow_custom || !q.options?.length)) {
    ...
    if (mainInput) {
      ...
      if (canSkip) {
        ...
        skipBtn.textContent = 'РџСЂРѕРїСѓСЃС‚РёС‚СЊ в†’';
        skipBtn.onclick = () => {
          _aiRestoreMainInputHandlers();
          _aiQuestionAnswers[_aiQuestionIdx] = null;
          _aiQuestionIdx++;
...
// РІвЂќР‚РІвЂќР‚ SSE РЎРѓРЎвЂљРЎР‚Р С‘Р СР С‘Р Р…Р С– РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
function _aiConnectSse() {
  ...
  _aiSse.addEventListener('chunk', (e) => {
    try {
      ...
      if (text && text.startsWith('__THINK__')) {
        ...
        _aiAddLiveLog({ icon: 'СЂСџвЂ™В­', text: text.slice(9), type: 'think' });
        return;
      }
      if (/<\/?think>/i.test(text)) {
        const thinkOnly = text.replace(/<\/?think>/gi, '').trim();
        if (thinkOnly) _aiAddLiveLog({ icon: 'рџ’­', text: thinkOnly, type: 'think' });
        return;
      }
      ...
      _aiStreamBubble.innerHTML = _aiRenderMarkdown(_aiStreamContent) + '<span class="ai-cursor">РІвЂ“вЂ№</span>';
      _aiSmartScroll();
    } catch {}
  });
  ...
  // Р¤Р°Р№Р»С‹ Р±СѓС„РµСЂРёР·СѓРµРј Рё РїРѕРєР°Р·С‹РІР°РµРј С‚РѕР»СЊРєРѕ РїРѕСЃР»Рµ РїРѕР»РЅРѕРіРѕ РѕС‚РІРµС‚Р° (done)
...
function _aiAddRealVideoMessage(base64url, prompt, fileId, filename) {
  ...
  // iOS requires user gesture for play РІР‚вЂќ show native controls
...
function _aiCreateStreamBubble() {
  ...
  bubble.innerHTML = '<span class="ai-cursor">РІвЂ“вЂ№</span>';
...
let _aiAgentStatus = {
  aura:   { status: 'idle', text: 'РћР¶РёРґР°СЋ' },
  coder:  { status: 'idle', text: 'РћР¶РёРґР°СЋ' },
  visual: { status: 'idle', text: 'РћР¶РёРґР°СЋ' }
};
...
function _aiRenderAgentPanel() {
  if (!_aiAgentPanel) return;
  const make = (key) => {
    const st = _aiAgentStatus[key] || { status: 'idle', text: 'РћР¶РёРґР°СЋ' };
...
function _aiFlushLiveLogQueue() {
  ...
  batch.forEach((d) => {
    ...
    if (['aura', 'coder', 'visual'].includes(agent)) {
      if (d.type === 'result') _aiUpdateAgentStatus(agent, 'ready', d.text || 'Р“РѕС‚РѕРІРѕ');
      else if (d.type === 'think') _aiUpdateAgentStatus(agent, 'thinking', d.text || 'Р”СѓРјР°СЋ');
      else if (d.type === 'process' || d.type === 'write' || d.type === 'check' || d.type === 'fetch') _aiUpdateAgentStatus(agent, 'working', d.text || 'Р Р°Р±РѕС‚Р°СЋ');
    }
    ...
    if (summary) summary.textContent = `${agentLabel}: ${String(d.text || 'Р Р°Р±РѕС‚Р°СЋ...').slice(0, 120)}`;
  });
...
function _aiRenderMarkdown(text) {
  return esc(text)
    ...
    .replace(/^РІР‚Сћ (.+)$/gm, '<li style="margin-left:12px">$1</li>')
    .replace(/\n/g, '<br>');
}
...
async function aiSend() {
  ...
  if ((isImgRequest || isVidRequest) && !attach) {
    ...
    try {
      ...
      if (d.error) {
        if (typing) typing.remove();
        _aiAddMessage('assistant', 'РІС™В РїС‘РЏ ' + d.error);
      } else if (d.pending) {
  ...
  // РІвЂќР‚РІвЂќР‚ Р С™Р С•Р Р…Р ВµРЎвЂ  Р С—Р ВµРЎР‚Р ВµРЎвЂ¦Р Р†Р В°РЎвЂљР В° РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
// РІвЂќР‚РІвЂќР‚ Debug mode handling РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
async function testMic() {
  ...
  } catch (e) { out.textContent = 'РІСњРЉ ' + e.message; out.style.color = 'var(--danger)'; }
}
...
function selectTheme(t) {
  ...
  // Apply instantly РІР‚вЂќ no separate button needed
...
// РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’
//  CALLS РІР‚вЂќ WebRTC + Socket.IO (clean rewrite)
// РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’
...
// РІвЂќР‚РІвЂќР‚ HELPERS РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
function callTarget() {
...
// РІвЂќР‚РІвЂќР‚ OUTGOING РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
// РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’
// РІвЂќР‚РІвЂќР‚ Audio system РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
let _audioCtx = null;
...
// РІвЂќР‚РІвЂќР‚ Custom notification sound РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
async function startCall(isVid) {
  ...
  try {
    ...
    if (typeof target === 'object' && target.type === 'group') {
      ...
      if (_groupMembers.length === 0 && _groupBotTargets.length === 0) { toast('Р’ РіСЂСѓРїРїРµ РЅРµС‚ СѓС‡Р°СЃС‚РЅРёРєРѕРІ', 'warning'); _cleanup(); return; }
...
async function _initiateGroupPeer(member) {
  ...
  pc.onconnectionstatechange = () => {
    ...
    // 'failed' вЂ” РЅРµ СѓРґР°Р»СЏРµРј СЃСЂР°Р·Сѓ, РґР°С‘Рј С€Р°РЅСЃ ICE restart
  };
  ...
  pc.oniceconnectionstatechange = () => {
    ...
    if (st === 'failed') {
      ...
      if (_groupIceRestarts <= 2) {
        ...
        // РЈС‡Р°СЃС‚РЅРёРє РЅРµРґРѕСЃС‚РёР¶РёРј вЂ” СѓР±РёСЂР°РµРј РµРіРѕ РїР»РёС‚РєСѓ
        groupPeers.delete(member);
...
function _updateGroupCallStatus() {
  ...
  if (statusEl) {
    if (connectedCount === 0 && botCount === 0) statusEl.textContent = 'РЎРѕРµРґРёРЅРµРЅРёРµ...';
    else {
      const current = connectedCount + botCount + 1;
      const total = totalCount + botCount + 1;
      statusEl.textContent = `${current} СѓС‡Р°СЃС‚РЅРёРє${current !== total ? ` РёР· ${total}` : ''}`;
    }
  }
}
...
function _normalizeBotSpeechTranscript(text) {
  return String(text || '')
    .replace(/[^\S\r\n]+/g, ' ')
    .replace(/\b(СЌРј|РєС…Рј|СЌСЌ+|РјРј+)\b/gi, ' ')
...
function _emitBotHeardTranscript(text, final = true, alternatives = []) {
  const clean = _normalizeBotSpeechTranscript(text);
  if (clean.length < 2) return;
  if (_lastBotSpeech.text === clean && (Date.now() - _lastBotSpeech.at) < 1800) return;
  _lastBotSpeech = { text: clean, at: Date.now() };
  socket.emit('human-bot-heard', {
    room: _callRoom || currentRoom,
    text: clean,
    final: !!final,
    alternatives: (alternatives || []).map(_normalizeBotSpeechTranscript).filter(Boolean).slice(0, 3)
  });
}

function _queueBotHeardTranscript(text, final = false, alternatives = []) {
  const clean = _normalizeBotSpeechTranscript(text);
  ...
  const waitMs = final ? 0 : (clean.length < 18 ? 120 : 220);
  _botSpeechDebounceTimer = setTimeout(() => {
    if (!final && _botSpeechDraft !== clean) return;
    _emitBotHeardTranscript(clean, final, alternatives);
  }, waitMs);
}
  ...
  try {
    ...
    rec.onresult = (ev) => {
      for (let i = ev.resultIndex; i < ev.results.length; i++) {
        ...
        const alternatives = Array.from(r).map(x => x?.transcript || '').filter(Boolean);
        if (r.isFinal) _queueBotHeardTranscript(best, true, alternatives);
        else _queueBotHeardTranscript(best, false, alternatives);
      }
    };
    rec.onerror = () => {};
    rec.onend = () => {
...
function _showGroupCallUI(groupName, members) {
  ...
  win.className = 'group-call-win gcw-compact';
  win.id = 'groupCallWin';
  ...
  win.innerHTML = `
    ...
    <div class="gcw-top">
      <div class="gcw-handle" aria-hidden="true"></div>
      <div class="gcw-headline">
        <div class="gcw-title-wrap">
...
function _addGroupParticipantTile(grid, member, stream, isLocal) {
  ...
  if (vid && stream) {
    ...
    // РЎРѕС…СЂР°РЅСЏРµРј С„Р»Р°Рі РЅР°Р»РёС‡РёСЏ РєР°РјРµСЂС‹ РЅР° РїР»РёС‚РєРµ (РЅРµ РґРµРјРєРё!)
    ...
    if (hasVideo) {
      ...
      // Р‘РђР“ 5: РѕРїСЂРµРґРµР»СЏРµРј РѕСЂРёРµРЅС‚Р°С†РёСЋ РєРѕРіРґР° РјРµС‚Р°РґР°РЅРЅС‹Рµ Р·Р°РіСЂСѓР·СЏС‚СЃСЏ
...
async function flipGroupCamera() {
  ...
  // РћСЃС‚Р°РЅР°РІР»РёРІР°РµРј СЃС‚Р°СЂС‹Р№ С‚СЂРµРє Рё Р¶РґС‘Рј РѕСЃРІРѕР±РѕР¶РґРµРЅРёСЏ РєР°РјРµСЂС‹
  ...
  if (!newStream) {
    toast('РќРµ СѓРґР°Р»РѕСЃСЊ РїРµСЂРµРєР»СЋС‡РёС‚СЊ РєР°РјРµСЂСѓ', 'error', 2000);
...
// в”Ђв”Ђ РџРµСЂРµРІРѕСЂРѕС‚ РєР°РјРµСЂС‹ РІ РїСЂРёРІР°С‚РЅРѕРј РІРёРґРµРѕР·РІРѕРЅРєРµ в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
async function flipPrivateCamera() {
  ...
  // РћСЃС‚Р°РЅР°РІР»РёРІР°РµРј СЃС‚Р°СЂС‹Р№ С‚СЂРµРє РџР•Р Р’Р«Рњ вЂ” iOS/Android РѕСЃРІРѕР±РѕРґСЏС‚ РєР°РјРµСЂСѓ
  const oldTracks = localStream?.getVideoTracks() || [];
  oldTracks.forEach(t => t.stop());
  if (localStream) {
    oldTracks.forEach(t => { try { localStream.removeTrack(t); } catch {} });
  ...
  // РџР°СѓР·Р° 300ms С‡С‚РѕР±С‹ РєР°РјРµСЂР° СѓСЃРїРµР»Р° РѕСЃРІРѕР±РѕРґРёС‚СЊСЃСЏ (РєСЂРёС‚РёС‡РЅРѕ РЅР° iOS)
  await new Promise(r => setTimeout(r, 300));
...
// в”Ђв”Ђ Р’СЃРїРѕРјРѕРіР°С‚РµР»СЊРЅР°СЏ: РїРѕР»СѓС‡РёС‚СЊ РїРѕС‚РѕРє РЅСѓР¶РЅРѕР№ РєР°РјРµСЂС‹ СЃ С‚СЂРµРјСЏ С„РѕР»Р±СЌРєР°РјРё в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
async function _tryGetCameraStream(facingMode) {
  // 1. exact facingMode (iOS Safari, СЃРѕРІСЂРµРјРµРЅРЅС‹Р№ Chrome)
  try {
    return await navigator.mediaDevices.getUserMedia({
      audio: false, video: { facingMode: { exact: facingMode } }
    });
  } catch {}
  // 2. Р‘РµР· exact (РЅРµРєРѕС‚РѕСЂС‹Рµ Android WebView)
  try {
    return await navigator.mediaDevices.getUserMedia({
      audio: false, video: { facingMode }
    });
  } catch {}
  // 3. РџРѕ deviceId вЂ” РїРµСЂРµР±РёСЂР°РµРј СЃРїРёСЃРѕРє РєР°РјРµСЂ Рё Р±РµСЂС‘Рј РЅРµ С‚РµРєСѓС‰СѓСЋ
  try {
...
function _showBotSilentCallWindow() {
  ...
  win.innerHTML = `
    ...
    <div class="cw-audio-content" id="cwAudioContent" style="transition:opacity .3s">
      ...
      <div style="margin-top:8px;font-size:12px;color:var(--text3)">РІ Р·РІРѕРЅРєРµ Р±РµР· РјРёРєСЂРѕС„РѕРЅР°</div>
    </div>
...
// РІвЂќР‚РІвЂќР‚ INCOMING РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
socket.on('call-bot-invite', ({ from, room }) => {
  ...
  setAvatar(callAva, from, userAvatars[from]);
  callNm.textContent = userNicknames[from] || from;
  callSt.textContent = 'РІС…РѕРґСЏС‰РёР№ Р·РІРѕРЅРѕРєвЂ¦';
  callAct.innerHTML = `
...
socket.on('call-bot-accepted', ({ from, room }) => {
  ...
  _callConnectedTime = Date.now();
  if (callSt) callSt.textContent = 'РІ Р·РІРѕРЅРєРµ Р±РµР· РјРёРєСЂРѕС„РѕРЅР°';
  _showBotSilentCallWindow();
  startBotSpeechRecognition();
});
...
socket.on('call-bot-ended', ({ from }) => {
  if (_botSilentCall && _callTarget === from) {
    toast(`${userNicknames[from] || from} Р·Р°РІРµСЂС€РёР» Р·РІРѕРЅРѕРє`, 'info', 2000);
    _cleanup();
  }
});
...
socket.on('call-bot-group-joined', ({ room, username }) => {
  ...
  _updateGroupCallStatus();
  startBotSpeechRecognition();
  toast(`${userNicknames[username] || username} Р·Р°С€С‘Р» РІ Р·РІРѕРЅРѕРє Р±РµР· РјРёРєСЂРѕС„РѕРЅР°`, 'info', 1800);
});
...
// РІвЂќР‚РІвЂќР‚ ANSWER РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
function answerCall() {
  stopRing();
...
// 2. Receive offer РІР‚вЂќ initial call OR renegotiation (screen share)
...
// Caller started screen share (replaceTrack path РІР‚вЂќ no ontrack fired)
socket.on('screen-share-started', ({ from }) => {
  ...
  if (rv && rv.srcObject) {
    ...
    // Audio call РІР‚вЂќ need to show video
...
socket.on('screen-share-stopped', ({ from }) => {
  ...
  // РЈР±РёСЂР°РµРј РІРёРґРµРѕ РїР°СЂС‚РЅС‘СЂР° С‚РѕР»СЊРєРѕ РµСЃР»Рё РњР« РўРћР–Р• РЅРµ С€Р°СЂРёРј
  // (РµСЃР»Рё РјС‹ С€Р°СЂРёРј вЂ” #rv РїРѕРєР°Р·С‹РІР°РµС‚ РЅР°С€ СЌРєСЂР°РЅ, С‚СЂРѕРіР°С‚СЊ РЅРµ РЅР°РґРѕ)
  if (!_screenSharing) {
    const rv = document.querySelector('#rv');
    if (rv) {
      rv.remove();
    ...
    // Р’РѕСЃСЃС‚Р°РЅР°РІР»РёРІР°РµРј cwAudioContent С‚РѕР»СЊРєРѕ РµСЃР»Рё РјС‹ С‚РѕР¶Рµ РЅРµ С€Р°СЂРёРј
    const cwAudio = document.getElementById('cwAudioContent');
    if (cwAudio) cwAudio.style.display = '';
  }
  // Р•СЃР»Рё РјС‹ С€Р°СЂРёРј вЂ” РЅРёС‡РµРіРѕ РЅРµ С‚СЂРѕРіР°РµРј, РЅР°С€Р° РґРµРјРѕРЅСЃС‚СЂР°С†РёСЏ РїСЂРѕРґРѕР»Р¶Р°РµС‚СЃСЏ
});
...
// РІвЂќР‚РІвЂќР‚ RTC PEER РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
function _createPeer() {
  ...
  rtcPeer.ontrack = ({ track, streams }) => {
    ...
    if (_connected && track.kind === 'video') {
      if (!rv) {
        // Audio call РІР‚вЂќ create video element to show screen share
        _showScreenReceived(remoteStream);
      }
      // Video call РІР‚вЂќ rv already updated above with new srcObject, no extra action needed
    }
  ...
  rtcPeer.onconnectionstatechange = () => {
    ...
    console.log('[RTC]', st);
    if (st === 'connected') {
      _iceRestartCount = 0; // СЃР±СЂР°СЃС‹РІР°РµРј СЃС‡С‘С‚С‡РёРє РїСЂРё СѓСЃРїРµС€РЅРѕРј СЃРѕРµРґРёРЅРµРЅРёРё
    }
    // РќР• РґРµР»Р°РµРј cleanup СЃСЂР°Р·Сѓ РїСЂРё failed вЂ” ICE restart РјРѕР¶РµС‚ РІРѕСЃСЃС‚Р°РЅРѕРІРёС‚СЊ СЃРѕРµРґРёРЅРµРЅРёРµ
  ...
  rtcPeer.oniceconnectionstatechange = () => {
    ...
    console.log('[ICE]', st);
    if (st === 'disconnected') {
      // Р’СЂРµРјРµРЅРЅС‹Р№ СЂР°Р·СЂС‹РІ вЂ” Р¶РґС‘Рј 4СЃ, РµСЃР»Рё РЅРµ РІРѕСЃСЃС‚Р°РЅРѕРІРёС‚СЃСЏ вЂ” РїСЂРѕР±СѓРµРј restart
      setTimeout(() => {
    ...
    if (st === 'failed') {
      ...
      if (_iceRestartCount <= 2) {
        // РџРµСЂРІС‹Рµ 2 РїРѕРїС‹С‚РєРё вЂ” РїСЂРѕСЃС‚Рѕ restartIce
        rtcPeer.restartIce?.();
        setTimeout(() => {
        ...
        // РСЃС‡РµСЂРїР°Р»Рё РїРѕРїС‹С‚РєРё вЂ” Р·Р°РІРµСЂС€Р°РµРј
        console.warn('[ICE] Exhausted restart attempts, ending call');
        toast('РЎРѕРµРґРёРЅРµРЅРёРµ РЅРµ СѓРґР°Р»РѕСЃСЊ вЂ” РїСЂРѕРІРµСЂСЊС‚Рµ СЃРµС‚СЊ', 'error', 4000);
        _cleanup();
      }
    }
  };
...
// РІвЂќР‚РІвЂќР‚ TURN FALLBACK РІР‚вЂќ recreate peer with TURN-first config РІвЂќР‚РІвЂќР‚
async function _recreatePeerWithTurnFallback() {
  ...
  rtcPeer.onconnectionstatechange = () => {
    ...
    if (st === 'closed') _cleanup();
    if (st === 'failed') {
      // РџРѕСЃР»РµРґРЅСЏСЏ РїРѕРїС‹С‚РєР° РїСЂРѕРІР°Р»РёР»Р°СЃСЊ вЂ” Р·Р°РІРµСЂС€Р°РµРј
      toast('РЎРѕРµРґРёРЅРµРЅРёРµ РЅРµ СѓРґР°Р»РѕСЃСЊ', 'error', 4000);
      _cleanup();
    }
  };
  rtcPeer.oniceconnectionstatechange = () => {
...
// РІвЂќР‚РІвЂќР‚ SCREEN RECEIVED (other person sharing screen during audio call) РІвЂќР‚РІвЂќР‚
...
// РІвЂќР‚РІвЂќР‚ Per-user volume control РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
// РІвЂќР‚РІвЂќР‚ CALL WINDOW РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
function _showCallWindow(remoteStream) {
  ...
  const btns = `
    ...
    ${_callIsVid && _isMobileUA ? `<button class="cw-btn cw-flip-cam" id="cwFlipBtn" onclick="flipPrivateCamera()" title="РџРµСЂРµРІРµСЂРЅСѓС‚СЊ РєР°РјРµСЂСѓ"><i class="ti ti-rotate"></i></button>` : ''}
  ...
  if (_callIsVid || _callNoCamera) {
    // Split-screen: РѕР±Р° РІРёРґРµРѕ РѕРґРёРЅР°РєРѕРІРѕРіРѕ СЂР°Р·РјРµСЂР°
  ...
  // Long-press screen button РІвЂ вЂ™ quality picker
  _setupScreenBtnLongPress(win);

  // Long-press window РІвЂ вЂ™ expand/collapse
...
function _setupScreenBtnLongPress(win) {
  ...
  if (!btn) return;
  let _lpt = null;
  // Short click РІвЂ вЂ™ start/stop screen share
  btn.addEventListener('click', () => switchToScreenShare());
  // Long press (500ms) РІвЂ вЂ™ quality picker (only when sharing)
        ...
        showScreenQualityPicker(async (opts) => {
          ...
          try {
            ...
            if (e.name !== 'NotAllowedError' && e.name !== 'AbortError') {
              toast('Р СњР Вµ РЎС“Р Т‘Р В°Р В»Р С•РЎРѓРЎРЉ РЎРѓР СР ВµР Р…Р С‘РЎвЂљРЎРЉ Р С”Р В°РЎвЂЎР ВµРЎРѓРЎвЂљР Р†Р С•: ' + e.message, 'error');
            }
          }
        });
      }
...
// РІвЂќР‚РІвЂќР‚ EXPAND / MINIMIZE call window РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
function makeDraggable(el) {
  let ox=0, oy=0;
  // Position from CSS (top-right) РІР‚вЂќ let CSS handle initial position
...
// РІвЂќР‚РІвЂќР‚ MUTE РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
function toggleMute() {
  _muted = !_muted;
...
// РІвЂќР‚РІвЂќР‚ GROUP SCREEN SHARE РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
socket.on('group-screen-share-started', ({ from }) => {
  ...
  if (tile) {
    ...
    // РџРµСЂРµРєР»СЋС‡Р°РµРј РЅР° contain С‡С‚РѕР±С‹ РЅРµ РѕР±СЂРµР·Р°Р»Рѕ РґРµРјРєСѓ, РїРѕРєР°Р·С‹РІР°РµРј РІРёРґРµРѕ
...
socket.on('group-screen-share-stopped', ({ from }) => {
  ...
  if (tile) {
    ...
    // РЈР±РёСЂР°РµРј fullscreen РµСЃР»Рё РїР»РёС‚РєР° Р±С‹Р»Р° СЂР°Р·РІС‘СЂРЅСѓС‚Р°
    ...
    if (pc && vid) {
      ...
      // Р–РёРІР°СЏ РєР°РјРµСЂР° вЂ” РІРѕСЃСЃС‚Р°РЅР°РІР»РёРІР°РµРј РІРёРґРµРѕ
      if (videoReceiver?.track && videoReceiver.track.readyState === 'live' && videoReceiver.track.enabled) {
        ...
        if (avaWrap) avaWrap.style.display = 'none';
        vid.play().catch(() => {});
        // Р’РѕСЃСЃС‚Р°РЅР°РІР»РёРІР°РµРј РѕСЂРёРµРЅС‚Р°С†РёСЋ РїРѕ СЂРµР°Р»СЊРЅРѕРјСѓ СЂР°Р·РјРµСЂСѓ РєР°РґСЂР°
        const applyOri = () => {
          if (vid.videoWidth && vid.videoHeight) {
            const isPortrait = vid.videoHeight > vid.videoWidth;
            vid.style.objectFit = isPortrait ? 'contain' : 'cover';
    ...
    // РќРµС‚ Р¶РёРІРѕР№ РєР°РјРµСЂС‹ РёР»Рё РЅРµС‚ peer вЂ” РїРѕРєР°Р·С‹РІР°РµРј Р°РІР°С‚Р°СЂРєСѓ
    if (!restored) {
      if (vid) {
        vid.srcObject = null;
        vid.style.objectFit = '';
...
function toggleGroupMute() {
  _muted = !_muted;
  // РћС‚РєР»СЋС‡Р°РµРј/РІРєР»СЋС‡Р°РµРј Р°СѓРґРёРѕС‚СЂРµРєРё РІ localStream (РґР»СЏ Р»РѕРєР°Р»СЊРЅРѕРіРѕ РѕС‚РѕР±СЂР°Р¶РµРЅРёСЏ Рё РЅРѕРІС‹С… peer'РѕРІ)
  localStream?.getAudioTracks().forEach(t => { t.enabled = !_muted; });
  // РќР°РґС‘Р¶РЅС‹Р№ СЃРїРѕСЃРѕР± РґР»СЏ СѓР¶Рµ СѓСЃС‚Р°РЅРѕРІР»РµРЅРЅС‹С… peer-СЃРѕРµРґРёРЅРµРЅРёР№:
  // РјРµРЅСЏРµРј enabled РЅР° С‚СЂРµРєРµ СЃРµРЅРґРµСЂР° (СЌС‚Рѕ СЂР°Р±РѕС‚Р°РµС‚ РІ РѕС‚Р»РёС‡РёРµ РѕС‚ track РЅР°РїСЂСЏРјСѓСЋ)
  groupPeers.forEach(pc => {
  ...
  // РћР±РЅРѕРІР»СЏРµРј РёРєРѕРЅРєСѓ РјРёРєСЂРѕС„РѕРЅР° РІ СЃРІРѕРµР№ РїР»РёС‚РєРµ
...
// РІвЂќР‚РІвЂќР‚ SCREEN SHARE РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
async function _applyScreenShare(capturedStream) {
  ...
  if (existingSender) {
    // VIDEO CALL: use replaceTrack РІР‚вЂќ seamless, no renegotiation needed, ontrack fires on receiver
    try {
      await existingSender.replaceTrack(vid);
      await _applyScreenSenderQuality(existingSender, _lastScreenShareOpts);
      console.log('[SS] replaceTrack done РІР‚вЂќ receiver gets new video');
    ...
    try {
      ...
      console.log('[SS] Renegotiation offer sent for audioРІвЂ вЂ™screen');
    } catch(e) { console.error('[SS] renegotiation error:', e); return; }
  }

  // РџСЂРё РґРµРјРѕРЅСЃС‚СЂР°С†РёРё СЌРєСЂР°РЅР°: СЃРєСЂС‹РІР°РµРј split, РїРѕРєР°Р·С‹РІР°РµРј РїРѕР»РЅРѕСЌРєСЂР°РЅРЅС‹Р№ rv
  const win = document.getElementById('activeCallWin');
  const split = win?.querySelector('#cwSplit');
  if (split) split.style.display = 'none';
  // Р”РѕР±Р°РІР»СЏРµРј РёР»Рё РѕР±РЅРѕРІР»СЏРµРј #rv РїРѕРІРµСЂС… split РґР»СЏ РїРѕРєР°Р·Р° СЃРІРѕРµРіРѕ СЌРєСЂР°РЅР°
  ...
  // РњР°Р»РµРЅСЊРєРёР№ PIP СЃРІРѕРµР№ РєР°РјРµСЂС‹ РІ СѓРіР»Сѓ
...
async function switchToScreenShare() {
  ...
  if (_screenSharing) {
    ...
    // РЈР±РёСЂР°РµРј РїСЂРµРІСЊСЋ СЌРєСЂР°РЅР° Рё РІРѕСЃСЃС‚Р°РЅР°РІР»РёРІР°РµРј split
    ...
    if (win2) {
      ...
      // Р’РѕСЃСЃС‚Р°РЅР°РІР»РёРІР°РµРј РєР°РјРµСЂСѓ РІ lv
      const lv = win2.querySelector('#lv');
      if (lv && lv.tagName === 'VIDEO' && localStream) {
        lv.srcObject = localStream;
        lv.style.cssText = ''; // СЃР±СЂР°СЃС‹РІР°РµРј inline СЃС‚РёР»Рё вЂ” CSS РєР»Р°СЃСЃ СѓРїСЂР°РІР»СЏРµС‚ СЂР°Р·РјРµСЂРѕРј
        lv.play().catch(() => {});
      }
    }
...
// РІвЂќР‚РІвЂќР‚ END / CLEANUP РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
function _cleanup() {
  ...
  _groupBotTargets = [];
  _callGroupName = null;
  _gcwFacingMode = 'user'; // СЃР±СЂР°СЃС‹РІР°РµРј РЅР° С„СЂРѕРЅС‚Р°Р»СЊРЅСѓСЋ РєР°РјРµСЂСѓ
  _cwFacingMode  = 'user';
...
// РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’
// РІвЂќР‚РІвЂќР‚ Video Circle РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
// РІвЂќР‚РІвЂќР‚ Collapse Р С•Р В±РЎР‚Р В°РЎвЂљР Р…Р С• РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
// РІвЂќР‚РІвЂќР‚ Double-tap РІвЂ вЂ™ fullscreen overlay РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚РІвЂќР‚
...
// РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’РІвЂўС’
// Smart real-time polling РІР‚вЂќ every 8s as fallback for socket misses
let _lastFriendsHash = '';
let _lastReqsHash    = '';
let _lastSentReqsHash = '';
setInterval(async () => {
  if (!currentUser) return;
  try {
    const r = await fetch('/api/get-user-data', {
    ...
    const newSentRqHash = JSON.stringify((d.sentFriendRequests||[]).sort());
